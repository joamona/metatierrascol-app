/**Este servicio, WebSQLiteService, funciona en web, 
 * y el servicio nativo, NativeSQLiteService, no funciona en native 
 * 
 * Si es nativo, los datos se quedan en el móvil aunque se cierre la app.
